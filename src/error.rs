...
impl error::Error for Error {
    ...
    fn description(&self) -> &str {
        match *self {
            ...
            Error::SequenceDataNotFound(_) => "Sequence data not found",
    ...
    fn cause(&self) -> Option<&error::Error> {
        match *self {
           ...
           Error::SequenceDataNotFound(_) => None,
...
impl fmt::Display for Error {
    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Error::SequenceDataNotFound(ref seqid) => write!(f,
                "Sequence data not found: '{}'", seqid),
